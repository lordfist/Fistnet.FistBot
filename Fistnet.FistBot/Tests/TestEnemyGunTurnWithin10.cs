...
{
    public class TestEnemyGunTurnWithin10 : TestBase
    {
        public override TestTypeEnum TestType
        {
            get { return TestTypeEnum.TestEnemyGunTurnWithin10; }
        }
        ...
        public override bool Evaluate()
        {
                ...
                && (this.Owner.Time - this.Owner.ActiveField.TrackedEnemy.Time) < Common.MAX_TIME_DISTANCE_TEST)
            {
                ...
                return (Math.Abs(turn) < 10);
            }

            return eval;
        }

        public TestEnemyGunTurnWithin10(BotBase owner)
            : base(owner)
        {
        }
    }
