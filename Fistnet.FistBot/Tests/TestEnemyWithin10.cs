...
{
    public class TestEnemyWithin10 : TestBase
    {
        public override TestTypeEnum TestType
        {
            get { return TestTypeEnum.TestEnemyWithin10; }
        }
        ...
        public override bool Evaluate()
        {
            ...
            {
                eval = (this.Owner.ActiveField.TrackedEnemy.Distance <= 10);
            }

            return eval;
        }

        public TestEnemyWithin10(BotBase owner)
            : base(owner)
        {
        }
    }
