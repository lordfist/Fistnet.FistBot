...
{
    public class JumpFalseCondition : EvaluationBase
    {
        public override EvaluationTypeEnum EvalType
        {
            get { return EvaluationTypeEnum.JumpFalse; }
        }
        ...
        public JumpFalseCondition(BotBase owner, TestBase test, ActionBase action, ActionBase alternateAction, byte? jumpIdx, byte? alternateJumpIdx, byte index)
