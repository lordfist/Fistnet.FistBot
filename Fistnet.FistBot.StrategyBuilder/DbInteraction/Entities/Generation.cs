...
namespace Fistnet.FistBot.DAL
{
	...
	public class GenerationEntity : EntityModelBase
	{
		...
		static readonly Type DbTableClass = typeof(GenerationMeta);
	...
	public sealed class GenerationMeta : SealedDbTable
	{
		...
		static readonly string[] SequenceNameOverrides = new string[2];
		static readonly bool?[] AutoIncrementOverrides = new bool?[2];
		...
		static readonly string[] ColumnNames = new string[2];
